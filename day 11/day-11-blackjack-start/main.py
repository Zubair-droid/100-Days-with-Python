...
def calculate_score(cards):
  """Takes list as input and returns score"""
...
def compare(user_score,computer_score):
  if user_score == computer_score:
    ...
    return "You gone beyond, Lose 😪"
  elif computer_score > 21:
    return "Opponent goes beyond, You Win 🤩"
...
def new_game():
  ...
  while not is_game_over:
    ...
    if user_score ==  0  or computer_cards == 0 or user_score > 21:
      ...
      should_continue = input("Do you want draw another card? Y/N: ")
...
while input("Do you want to start a blackjack game? Y?N: ") == "Y":
